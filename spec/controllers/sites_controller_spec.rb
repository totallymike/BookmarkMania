  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved site as @site" do
        ...
        post :create, {:site => {url: 'http://foo.com'}}, valid_session
        assigns(:site).should be_a_new(Site)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested site" do
        ...
        Site.any_instance.should_receive(:update).with({ 'url' => 'http://www.reddit.com' })
        put :update, {:id => site.to_param, :site => { :url => 'http://www.reddit.com' }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the site as @site" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Site.any_instance.stub(:save).and_return(false)
        put :update, {:id => site.to_param, :site => {url: site.url}}, valid_session
        assigns(:site).should eq(site)
      end
      ...
      it "re-renders the 'edit' template" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Site.any_instance.stub(:save).and_return(false)
        put :update, {:id => site.to_param, :site => {url: 'http://foo.com'}}, valid_session
